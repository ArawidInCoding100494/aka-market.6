  ...
  return (
    <>
      <div
        ...
        onClick={() => close(false)}
      >
        <div className="fixed w-[80%] lg:w-[35%] h-screen bg-[#2D5F5D] text-white border top-0 left-0 py-7.5 px-0 opacity-100 animate-[model_0.3s_forwards] overflow-auto z-9999"
